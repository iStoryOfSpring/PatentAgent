...
- [x] Phase 0 — 项目骨架 + 知识库
- [x] Phase 1 — 核心引擎拆分（9 模块）
- [x] Phase 2 — Agent 编排层（FSM + 10 Tools + LLM）
- [x] Phase 3 — 全文解析引擎（FullPatent 模型）
- [x] Phase 4 — 语义检索（ChromaDB + InMemory）
- [x] Phase 5 — GUI 交互升级（对话中心 + 报告）
- [x] Phase 6 — 高级分析工具（5 个新 Tool）
- [x] Phase 7 — 多 Agent 协作（Search∥Analysis→Report）
